...
async function compilePage(source, filepath, renderer, stats, config) {
  ...
  const { dependencies: pageDependencies, code } = resolveImports(js.code, config);
  ...
  try {
    ...
    return { html: html ? true : false, css: css ? true : false, dependencies: depender.dependencies };

...
export async function prerender(page, _cayo, config) {
...
export function processPage(content, page, _cayo, config, logger) {
  ...
  document.querySelectorAll('[data-cayo-src]').forEach((el) => {
    ...
    if (src !== '') {
      ...
      // Consider adding cayo component as a dep for this page using helpers from dependencies.js
  ...
  // Get component list
  // TODO: consider doing this in the loop above; don't need regex anymore really
